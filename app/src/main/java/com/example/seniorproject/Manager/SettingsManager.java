...
public class SettingsManager extends Fragment {
    ...
    public static SettingsManager newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.settings_manager, container, false);
        ChangeGoogleAccount = (Button) view.findViewById(R.id.changegmailm);
        ...
        SyncData = (Button) view.findViewById(R.id.syncdatam);
        ...
        ResetPassword = (Button) view.findViewById(R.id.resentmpass);
        ...
        Logout = (Button) view.findViewById(R.id.lougoutbuttm);
