...
public class IssuesCat extends Fragment {
    ...
    public static IssuesCat newInstance(String param1, String param2) {
        IssuesCat fragment = new IssuesCat();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.cat_issue, container, false);
        TableLayout fragsTable = (TableLayout) view.findViewById(R.id.issuestable);
    ...
    private void setTableRows(TableLayout tableLayout) {
        ...
        ArrayList<IssueFile> stateFiles = localDBHelper.getAllIssuesFiles();
        ...
        for (int i = 0; i < stateFiles.size(); i++) {
            ...
            tableRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    LocalDBHelper.storeDataInSharedPreference(getContext(),"cat","Issue");
