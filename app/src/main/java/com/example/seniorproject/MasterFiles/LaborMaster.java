...
import com.example.seniorproject.Admin.EditLabor;
...
public class LaborMaster extends Fragment {
    ...
    public static LaborMaster newInstance(String param1, String param2) {
        LaborMaster fragment = new LaborMaster();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.labor_master_file, container, false);
        TableLayout tableLayout = (TableLayout) view.findViewById(R.id.labortable);
    ...
    private void setTableRows(TableLayout tableLayout) {
        ...
        ArrayList<LaborInstallFile> stateFiles = localDBHelper.getAllLaborFiles();
        ...
        for (int i = 0; i < stateFiles.size(); i++) {
            ...
            for (int j = 0; j < 4; j++) {
                ...
                if (j == 0) {
                    ...
                    textView.setText(String.valueOf(stateFiles.get(i).theCrewRate));
                    textView.setLayoutParams(new TableRow.LayoutParams(0, TableRow.LayoutParams.MATCH_PARENT, 1f));
                } else if (j == 3) {
                    textView.setText(String.valueOf(stateFiles.get(i).thePerDiem));
                    textView.setLayoutParams(new TableRow.LayoutParams(0, TableRow.LayoutParams.MATCH_PARENT, 1f));
                }
            ...
            tableRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getActivity(), EditLabor.class);
