...
import com.example.seniorproject.Admin.EditMobilization;
import com.example.seniorproject.Admin.EditPriority;
...
public class MobilizationMaster extends Fragment {
    ...
    public static MobilizationMaster newInstance(String param1, String param2) {
        MobilizationMaster fragment = new MobilizationMaster();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.mobilization_master_file, container, false);
        TableLayout tableLayout = (TableLayout)view.findViewById(R.id.mobiletable);
    ...
    private void setTableRows(TableLayout tableLayout) {
        ...
        ArrayList<MobilizationFile> stateFiles = localDBHelper.getAllMobilizationFiles();
        ...
        for (int i = 0; i < stateFiles.size(); i++) {
            ...
            for (int j = 0; j < 4; j++) {
                ...
                if (j == 0) {
                    textView.setText(String.valueOf(stateFiles.get(i).theID));
                    ...
                    textView.setText(String.valueOf(stateFiles.get(i).theMinimum));
                    textView.setLayoutParams(new TableRow.LayoutParams(0, TableRow.LayoutParams.MATCH_PARENT, 1f));
                } else if (j == 3) {
                    textView.setText(String.valueOf(stateFiles.get(i).thetravel));
                    textView.setLayoutParams(new TableRow.LayoutParams(0, TableRow.LayoutParams.MATCH_PARENT, 1f));
                }
            ...
            tableRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getActivity(), EditMobilization.class);
