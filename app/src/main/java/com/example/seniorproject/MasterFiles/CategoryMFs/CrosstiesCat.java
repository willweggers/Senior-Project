...
public class CrosstiesCat extends Fragment {
    ...
    public static CrosstiesCat newInstance(String param1, String param2) {
        CrosstiesCat fragment = new CrosstiesCat();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.cat_crossties, container, false);
        TableLayout fragsTable = (TableLayout) view.findViewById(R.id.crosstietable);
    ...
    private void setTableRows(TableLayout tableLayout) {
        ...
        ArrayList<CrosstiesFile> stateFiles = localDBHelper.getAllCrosstiesFiles();
        ...
        for (int i = 0; i < stateFiles.size(); i++) {
            ...
            tableRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    LocalDBHelper.storeDataInSharedPreference(getContext(),"cat","Crossties");
