...
public class CrossingCat extends Fragment {
    ...
    public static CrossingCat newInstance(String param1, String param2) {
        CrossingCat fragment = new CrossingCat();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.cat_crossing, container, false);
        TableLayout fragsTable = (TableLayout) view.findViewById(R.id.crossingtable);
    ...
    private void setTableRows(TableLayout tableLayout) {
        ...
        ArrayList<CrossingsFile> stateFiles = localDBHelper.getAllCrossingsFiles();
        ...
        for (int i = 0; i < stateFiles.size(); i++) {
            ...
            tableRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    LocalDBHelper.storeDataInSharedPreference(getContext(),"cat","Crossings");
