...
public class PriorityMaster extends Fragment {
    ...
    public static PriorityMaster newInstance(String param1, String param2) {
        PriorityMaster fragment = new PriorityMaster();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.priority_master_file, container, false);
        TableLayout tableLayout = (TableLayout) view.findViewById(R.id.priroritytable);
    ...
    private void setTableRows(TableLayout tableLayout) {
        ...
        ArrayList<PriorityFile> stateFiles = localDBHelper.getAllPriorityFiles();
        ...
        for (int i = 0; i < stateFiles.size(); i++) {
            ...
            final int id = stateFiles.get(i).theID;
            tableRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getActivity(), EditPriority.class);
                    LocalDBHelper.storeDataInSharedPreference(getContext(), "rowviewing",Integer.toString(id));
