...
public class RaileMasterFile extends Fragment {
    ...
    public static RaileMasterFile newInstance(String param1, String param2) {
        RaileMasterFile fragment = new RaileMasterFile();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.cat_rail, container, false);
        TableLayout fragsTable = (TableLayout) view.findViewById(R.id.railtable);
    ...
    private void setTableRows(TableLayout tableLayout) {
        ...
        ArrayList<RailFile> stateFiles = localDBHelper.getAllRailFiles();
        ...
        for (int i = 0; i < stateFiles.size(); i++) {
            ...
            tableRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    LocalDBHelper.storeDataInSharedPreference(getContext(),"cat","Rail");
