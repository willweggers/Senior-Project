...
public class TurnoutCat extends Fragment {
    ...
    public static TurnoutCat newInstance(String param1, String param2) {
        TurnoutCat fragment = new TurnoutCat();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.cat_turnouts, container, false);
        TableLayout fragsTable = (TableLayout) view.findViewById(R.id.turnouttable);
    ...
    private void setTableRows(TableLayout tableLayout) {
        ...
        ArrayList<TurnoutsFile> stateFiles = localDBHelper.getAllTurnoutFiles();
        ...
        for (int i = 0; i < stateFiles.size(); i++) {
            ...
            tableRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    LocalDBHelper.storeDataInSharedPreference(getContext(),"cat","Turnout");
