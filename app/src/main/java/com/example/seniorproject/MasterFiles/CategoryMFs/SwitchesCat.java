...
public class SwitchesCat extends Fragment {
    ...
    public static SwitchesCat newInstance(String param1, String param2) {
        SwitchesCat fragment = new SwitchesCat();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.cat_switchties, container, false);
        TableLayout fragsTable = (TableLayout) view.findViewById(R.id.switchtietable);
    ...
    private void setTableRows(TableLayout tableLayout) {
        ...
        ArrayList<SwitchTiesFile> stateFiles = localDBHelper.getAllSwitchTiesFiles();
        ...
        for (int i = 0; i < stateFiles.size(); i++) {
            ...
            tableRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    LocalDBHelper.storeDataInSharedPreference(getContext(),"cat","Switches");
