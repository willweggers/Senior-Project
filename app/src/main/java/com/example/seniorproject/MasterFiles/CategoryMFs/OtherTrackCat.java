...
public class OtherTrackCat extends Fragment {
    ...
    public static OtherTrackCat newInstance(String param1, String param2) {
        OtherTrackCat fragment = new OtherTrackCat();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.cat_other_track_mat, container, false);
        TableLayout fragsTable = (TableLayout) view.findViewById(R.id.othertrackmattable);
    ...
    private void setTableRows(TableLayout tableLayout) {
        ...
        ArrayList<OTMFile> stateFiles = localDBHelper.getAllOTMFiles();
        ...
        for (int i = 0; i < stateFiles.size(); i++) {
            ...
            tableRow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    LocalDBHelper.storeDataInSharedPreference(getContext(),"cat","OtherTrack");
