...
/**
 * Created by willw on 11/23/2017.
 */
...
public class SettingsAdmin extends Fragment {
    ...
    public static SettingsAdmin newInstance(String param1, String param2) {
        SettingsAdmin fragment = new SettingsAdmin();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.settings_admin, container, false);

        SyncData = (Button) view.findViewById(R.id.syncdataa);
        ...
        ResetPassword = (Button) view.findViewById(R.id.resentapass);
        ...
        Logout = (Button) view.findViewById(R.id.lougoutbutta);
